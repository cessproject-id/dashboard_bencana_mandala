...
function updateRealtimeInfo() {
    ...
    // Format Hari & Tanggal (Contoh: SABTU, 05 SEPTEMBER 2026)
...
// Jalankan fungsi setiap 1 detik agar jam pada running text ikut bergerak realtime
setInterval(updateRealtimeInfo, 1000);
updateRealtimeInfo();

/**
 * CONTOH FUNGSI UNTUK MENGUPDATE NILAI DATA BENCANA (DARI DATABASE/API)
 */
